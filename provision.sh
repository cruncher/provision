...
apt-get -y  install memcached libjpeg-dev libfreetype6-dev python-dev python3-dev python-virtualenv python3-virtualenv python-pip python3-pip git-core screen zsh vim gettext ncftp shorewall unzip ncurses-dev
